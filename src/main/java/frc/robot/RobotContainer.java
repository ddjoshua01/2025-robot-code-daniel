...
public class RobotContainer {
    ...
    //            new Camera(
    //                    "leftCam", Camera.CameraType.PHOTONVISION,
    // VisionConstants.LOW_CAM_TRANSFORM);
    //
    ...
    private void configureBindings() {
        ...
        primaryController.dpadDown.whileTrue(new ClimbCommand(primaryController, climberSubsystem));

        primaryController.dpadUp.whileTrue(new ClimbCommand(primaryController, climberSubsystem));

        primaryController.dpadRight.whileTrue(
                new ClimbCommand(primaryController, climberSubsystem));

        primaryController.dpadLeft.whileTrue(new ClimbCommand(primaryController, climberSubsystem));
        ...
        //                        new ParallelCommandGroup(
        //                                new AlignCommand(swerveSubsystem, targetPose, true,
        // "fine"),
        ...
        // DriveTestCommand(swerveSubsystem));
        ...
        //                        "arm_intake",
        //                        "elevator_intake"));
        //        primaryController.dpadDown.whileTrue(new RunCommand(() ->
        // swerveSubsystem.zeroGyro()));
        //
        //        primaryController.dpadRight.whileTrue(new
        // ElevatorPositionCommand(elevatorSubsystem, 0.4));
